    ...
    <footer className="bg-slate-900 text-slate-300 mt-16 no-print">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-display font-bold text-xl text-white">
                Calc<span className="text-brand-400">Wise</span>
              </span>
            </div>
            <p className="text-sm text-slate-400 max-w-sm leading-relaxed">
              Free, accurate financial calculators for mortgage, line of credit, renovation, and recreational purchase planning. No signup required.
            </p>
            <p className="text-xs text-slate-500 mt-4">
              <strong className="text-slate-400">Disclaimer:</strong> CalcWise provides calculators for educational purposes only. Results are estimates and should not be considered financial advice. Consult a licensed financial advisor for personalized guidance.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="https://www.hud.gov" target="_blank" rel="noopener noreferrer" className="text-sm text-slate-400 hover:text-white transition-colors">HUD.gov</a></li>
        ...
        <div className="border-t border-slate-800 mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-xs text-slate-500">© {year} CalcWise. All rights reserved.</p>
