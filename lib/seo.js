...
export const SITE_DESCRIPTION = 'Free financial calculators for mortgage, line of credit, car loans, credit cards, renovation costs, and recreation purchases. Get instant, accurate results with detailed breakdowns.';
...
export const CALCULATORS = [
  ...
  },
  {
    ...
    keywords: 'credit card payoff calculator, credit card interest calculator, minimum payment calculator, credit card debt calculator',
    icon: '💳',
    color: 'red',
